      ...
      {!hasFile ? (
        <>
          <div
            ...
            <svg className={`w-7 h-7 transition-colors ${isDragActive ? 'text-purple-400' : 'text-zinc-500 group-hover:text-purple-400'}`} fill="none"
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-zinc-600 text-xs">o haz clic para seleccionar</p>
            <p className="text-zinc-700 text-xs">PDF · máx. 5MB</p>
          </div>
          <button
            type="button"
        ...
        <div className="w-full space-y-4 animate-in fade-in slide-in-from-bottom-4">
          <div className="flex items-center gap-4 bg-gradient-to-r from-purple-400/10 to-zinc-900 border border-purple-400/20 rounded-xl p-4">
            <div className="w-10 h-10 bg-purple-400/20 rounded-lg flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" strokeWidth="1.5"
                viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <div className="flex-1">
              <p className="text-zinc-300 text-sm font-semibold">curriculum_daniel_2025.pdf</p>
              <p className="text-zinc-500 text-xs mt-1">2.3 MB · Listo para analizar</p>
            </div>
            <button 
              type="button"
